...
public class GraphPaperLayout implements LayoutManager2 {
	...
	public GraphPaperLayout(Dimension gridSize) {
		this(gridSize, 0, 0, false);
	}

	public GraphPaperLayout(int rows, int columns) {
		this(rows, columns, 0, 0, true);
	}

	public GraphPaperLayout(int rows, int columns, int hgap, int vgap, boolean beSmart) {
		this(new Dimension(columns, rows), hgap, vgap, beSmart);
	}

	public GraphPaperLayout(Dimension gridSize, boolean beSmart) {
		this(gridSize, 0, 0, beSmart);
	}
	 ...
	 * or horizontal padding.
	 */
	public GraphPaperLayout(Dimension gridSize, int borderSZ) {
		this(gridSize);
	 ...
	 */
	public GraphPaperLayout(Dimension gridSize, int hgap, int vgap, boolean beSmart) {
			...
			if (ncomponents>0) {
				if (smart) {
					...
					for (int i = 0; i < ncomponents; i++) {
						...
						Rectangle rect = compTable.get(c);
						if (rect != null) {
							int x = insets.left + (totalCellW * rect.x) + hgap + borderSZ;
